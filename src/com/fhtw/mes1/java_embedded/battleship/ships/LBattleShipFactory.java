...
/**
 * @author stocki
 * Factory for L battleships
 */
public class LBattleShipFactory implements IBattleShipFactory {
	...
	public IBattleShip create(String[] initStringElems) throws BattleShipInstantiationFailed {
		try {
			return new LBattleShip(new Coordinate(initStringElems[0]), initStringElems[2],
